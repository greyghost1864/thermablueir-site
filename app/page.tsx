          ...
          <div className="container">
            ...
            <div className="how-grid">
              ...
              <div className="content-card side-card">
                <img src="/images/pete-blueprint.png?v=2" alt="Pete guiding the how it works section" className="pete-side-image pete-float-b" />
        ...
        <section id="faq" className="section section-alt">
          <div className="container">
            ...
            <div className="faq-grid">
              ...
              <div className="content-card side-card">
                <img src="/images/pete-guide.png?v=2" alt="Pete guiding the FAQ" className="pete-side-image pete-float-c" />
